...
if not isempty(conda_prefix) and string.find(conda_prefix, "envs") ~= nil then
  ...
  vim.g.python_host_prog = "/opt/homebrew/Caskroom/miniforge/base/envs/pynvim/bin/python"
  vim.g.python3_host_prog = "/opt/homebrew/Caskroom/miniforge/base/envs/pynvim/bin/python3"
